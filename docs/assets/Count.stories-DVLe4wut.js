import{j as e}from"./jsx-runtime-DiklIkkE.js";import{B as n}from"./Count-C23WycZA.js";const p=({children:t,gap:r=16})=>e.jsx("div",{style:{display:"flex",alignItems:"center",flexWrap:"wrap",gap:r},children:t}),c=({label:t,desc:r,children:o})=>e.jsxs("div",{style:{marginBottom:32},children:[e.jsx("p",{style:{fontFamily:"Pretendard, sans-serif",fontSize:11,fontWeight:700,letterSpacing:"0.07em",textTransform:"uppercase",color:"#9999B8",margin:"0 0 4px"},children:t}),r&&e.jsx("p",{style:{fontFamily:"Pretendard, sans-serif",fontSize:12,color:"#55557A",margin:"0 0 12px",lineHeight:1.6},children:r}),o]}),i=({children:t})=>e.jsx("p",{style:{fontFamily:"Pretendard, sans-serif",fontSize:11,color:"#9999B8",margin:"6px 0 0",textAlign:"center"},children:t}),C={title:"Assets/Badges/Count",component:n,parameters:{layout:"centered",docs:{description:{component:`
알림 카운트 뱃지 컴포넌트입니다.
...
}`,...(B=(k=d.parameters)==null?void 0:k.docs)==null?void 0:B.source}}};const S=["Playground","Sizes","Contents","Matrix"],A=Object.freeze(Object.defineProperty({__proto__:null,Contents:s,Matrix:d,Playground:a,Sizes:l,__namedExportsOrder:S,default:C},Symbol.toStringTag,{value:"Module"}));export{A as C,a as P};
