import{j as e}from"./jsx-runtime-DFAAy_2V.js";import{I as l}from"./ImageThumbnail-D8tMuG9b.js";import"./index-Bc2G9s8g.js";const o="https://images.unsplash.com/photo-1596367407372-96cb88503db6?q=80&w=800&auto=format&fit=crop",M=({children:r,gap:t=8})=>e.jsx("div",{style:{display:"flex",alignItems:"flex-start",flexWrap:"wrap",gap:t},children:r}),n=({label:r,desc:t,children:s})=>e.jsxs("div",{style:{marginBottom:32},children:[e.jsx("p",{style:{fontFamily:"Pretendard, sans-serif",fontSize:11,fontWeight:700,letterSpacing:"0.07em",textTransform:"uppercase",color:"var(--color-neutral-foreground-subtle-3)",margin:"0 0 4px"},children:r}),t&&e.jsx("p",{style:{fontFamily:"Pretendard, sans-serif",fontSize:12,color:"var(--color-neutral-foreground-subtle-1)",margin:"0 0 12px",lineHeight:1.6},children:t}),s]}),P=({children:r})=>e.jsx("p",{style:{fontFamily:"Pretendard,sans-serif",fontSize:11,color:"var(--color-neutral-foreground-subtle-3)",margin:"6px 0 0",textAlign:"center"},children:r}),W={title:"Components/Images/Circle",component:l,tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:`
...
}`,...(b=(h=i.parameters)==null?void 0:h.docs)==null?void 0:b.source}}};var v,z,S;d.parameters={...d.parameters,docs:{...(v=d.parameters)==null?void 0:v.docs,source:{originalSource:`{
  name: 'Type',
  render: () => <div style={{
    display: 'flex',
    flexDirection: 'column',
...
}`,...(S=(z=d.parameters)==null?void 0:z.docs)==null?void 0:S.source}}};var I,j,C;c.parameters={...c.parameters,docs:{...(I=c.parameters)==null?void 0:I.docs,source:{originalSource:`{
  name: 'State',
  render: () => <div style={{
    display: 'flex',
    flexDirection: 'column',
...
}`,...(C=(j=c.parameters)==null?void 0:j.docs)==null?void 0:C.source}}};var k,T,B;p.parameters={...p.parameters,docs:{...(k=p.parameters)==null?void 0:k.docs,source:{originalSource:`{
  name: 'Matrix',
  render: () => {
...
}`,...(B=(T=p.parameters)==null?void 0:T.docs)==null?void 0:B.source}}};const _=["Playground","Sizes","Types","States","Matrix"];export{p as Matrix,a as Playground,i as Sizes,c as States,d as Types,_ as __namedExportsOrder,W as default};
