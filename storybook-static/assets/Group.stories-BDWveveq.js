import{j as e}from"./jsx-runtime-DFAAy_2V.js";import{a as r}from"./ButtonGroup-XYOnsbYl.js";import"./index-Bc2G9s8g.js";const m=({children:l,gap:o=16})=>e.jsx("div",{style:{display:"flex",alignItems:"center",flexWrap:"wrap",gap:o},children:l}),t=({label:l,desc:o,children:a})=>e.jsxs("div",{style:{marginBottom:32},children:[e.jsx("p",{style:{fontFamily:"Pretendard, sans-serif",fontSize:11,fontWeight:700,letterSpacing:"0.07em",textTransform:"uppercase",color:"var(--color-neutral-foreground-subtle-3)",margin:"0 0 4px"},children:l}),o&&e.jsx("p",{style:{fontFamily:"Pretendard, sans-serif",fontSize:12,color:"var(--color-neutral-foreground-subtle-1)",margin:"0 0 12px",lineHeight:1.6},children:o}),a]}),P=({children:l})=>e.jsx("p",{style:{fontFamily:"Pretendard, sans-serif",fontSize:11,color:"var(--color-neutral-foreground-subtle-3)",margin:"6px 0 0",textAlign:"center"},children:l}),V={title:"Components/Buttons/Group",component:r,tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:`
...
}`,...(v=(y=n.parameters)==null?void 0:y.docs)==null?void 0:v.source}}};var L,j,B;i.parameters={...i.parameters,docs:{...(L=i.parameters)==null?void 0:L.docs,source:{originalSource:`{
  name: 'Size',
  render: () => <div style={{
    display: 'flex',
    flexDirection: 'column',
...
}`,...(B=(j=i.parameters)==null?void 0:j.docs)==null?void 0:B.source}}};var S,z,k;d.parameters={...d.parameters,docs:{...(S=d.parameters)==null?void 0:S.docs,source:{originalSource:`{
  name: 'State',
  render: () => <div style={{
    display: 'flex',
    flexDirection: 'column',
...
}`,...(k=(z=d.parameters)==null?void 0:z.docs)==null?void 0:k.source}}};var W,G,w;c.parameters={...c.parameters,docs:{...(W=c.parameters)==null?void 0:W.docs,source:{originalSource:`{
  name: 'Full Width',
  render: () => <div style={{
    display: 'flex',
    flexDirection: 'column',
...
}`,...(w=(G=c.parameters)==null?void 0:G.docs)==null?void 0:w.source}}};var D,A,q;p.parameters={...p.parameters,docs:{...(D=p.parameters)==null?void 0:D.docs,source:{originalSource:`{
  name: 'Labels',
  render: () => <div style={{
    display: 'flex',
    flexDirection: 'column',
...
}`,...(q=(A=p.parameters)==null?void 0:A.docs)==null?void 0:q.source}}};var C,R,F;u.parameters={...u.parameters,docs:{...(C=u.parameters)==null?void 0:C.docs,source:{originalSource:`{
  name: 'Matrix',
  render: () => {
...
}`,...(F=(R=u.parameters)==null?void 0:R.docs)==null?void 0:F.source}}};const X=["Playground","Shapes","Sizes","States","FullWidths","Labels","Matrix"];export{c as FullWidths,p as Labels,u as Matrix,s as Playground,n as Shapes,i as Sizes,d as States,X as __namedExportsOrder,V as default};
