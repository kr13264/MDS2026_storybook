import{j as e}from"./jsx-runtime-DiklIkkE.js";import{B as t}from"./Overlay-BJ4utkoh.js";const c=({children:r,gap:o=12})=>e.jsx("div",{style:{display:"flex",alignItems:"center",flexWrap:"wrap",gap:o},children:r}),a=({label:r,desc:o,children:l})=>e.jsxs("div",{style:{marginBottom:32},children:[e.jsx("p",{style:{fontFamily:"Pretendard, sans-serif",fontSize:11,fontWeight:700,letterSpacing:"0.07em",textTransform:"uppercase",color:"#9999B8",margin:"0 0 4px"},children:r}),o&&e.jsx("p",{style:{fontFamily:"Pretendard, sans-serif",fontSize:12,color:"#55557A",margin:"0 0 12px",lineHeight:1.6},children:o}),l]}),p=({children:r})=>e.jsx("p",{style:{fontFamily:"Pretendard, sans-serif",fontSize:11,color:"#9999B8",margin:"6px 0 0",textAlign:"center"},children:r}),S={title:"Assets/Badges/Overlay",component:t,parameters:{layout:"centered",docs:{description:{component:`
...
\`\`\`
        `.trim()}}},argTypes:{type:{control:"select",options:["basic","live","liveLabel"],description:"뱃지 타입"},color:{control:"select",options:["alpha","solid"],description:"배경 색상 (basic 전용)"},weight:{control:"select",options:["regular","bold"],description:"폰트 굵기 (basic 전용)"},text:{control:"text",description:"텍스트"},viewCount:{control:"text",description:"시청자 수 (liveLabel 전용)"}}},i={args:{type:"basic",color:"alpha",weight:"regular",text:"배지",viewCount:"1.6만 시청"}},n={tags:["!autodocs"],name:"Size",render:()=>e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:24},children:e.jsx(a,{label:"Measurement",children:e.jsx("div",{style:{overflowX:"auto"},children:e.jsxs("table",{style:{borderCollapse:"collapse",fontFamily:"Pretendard, sans-serif",fontSize:12,whiteSpace:"nowrap"},children:[e.jsx("thead",{children:e.jsx("tr",{style:{background:"var(--color-neutral-background-raised-1)",borderBottom:"1px solid var(--color-neutral-stroke-divider)"},children:["Attribute","Value"].map(r=>e.jsx("th",{style:{padding:"8px 24px",textAlign:"center",fontWeight:700,color:"var(--color-neutral-foreground-subtle-1)"},children:r},r))})}),e.jsx("tbody",{children:[["Height","26px"],["Border radius","999px (pill)"],["Font size","12px"],["Line height","16px"],["Letter spacing","-0.3px"],["Padding","5px 8px"]].map(r=>e.jsx("tr",{style:{background:"var(--color-neutral-background-default)",borderBottom:"1px solid var(--color-neutral-stroke-divider)"},children:r.map((o,l)=>e.jsx("td",{style:{padding:"8px 24px",textAlign:"center",color:l===0?"var(--color-neutral-foreground-subtle-1)":"var(--color-neutral-foreground-default)",fontWeight:l===0?600:400},children:o},l))},r[0]))})]})})})})},d={tags:["!autodocs"],name:"Contents",render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:24},children:[e.jsx(a,{label:"Basic — Alpha",desc:"반투명 검정 배경의 기본 뱃지.",children:e.jsxs(c,{children:[e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:4},children:[e.jsx(t,{color:"alpha",weight:"regular"}),e.jsx(p,{children:"Regular"})]}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:4},children:[e.jsx(t,{color:"alpha",weight:"bold"}),e.jsx(p,{children:"Bold"})]})]})}),e.jsx(a,{label:"Basic — Solid",desc:"파란색 배경의 기본 뱃지.",children:e.jsxs(c,{children:[e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:4},children:[e.jsx(t,{color:"solid",weight:"regular"}),e.jsx(p,{children:"Regular"})]}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:4},children:[e.jsx(t,{color:"solid",weight:"bold"}),e.jsx(p,{children:"Bold"})]})]})}),e.jsx(a,{label:"Live",desc:"라이브 방송 표시 뱃지.",children:e.jsx(c,{children:e.jsx(t,{type:"live"})})}),e.jsx(a,{label:"Live Label",desc:"라이브 + 시청자 수를 함께 표시하는 뱃지.",children:e.jsx(c,{children:e.jsx(t,{type:"liveLabel",viewCount:"1.6만 시청"})})})]})},s={tags:["!autodocs"],name:"Matrix",render:()=>{const r=["alpha","solid"],o=["regular","bold"];return e.jsx("div",{style:{fontFamily:"Pretendard, sans-serif",overflowX:"auto",padding:4},children:e.jsxs("table",{style:{borderCollapse:"collapse"},children:[e.jsx("thead",{children:e.jsxs("tr",{style:{background:"var(--color-neutral-background-raised-1)"},children:[e.jsx("th",{style:{padding:"8px 16px 8px 0",textAlign:"left",fontSize:11,color:"var(--color-neutral-foreground-subtle-3)",fontWeight:700,letterSpacing:"0.07em",textTransform:"uppercase"},children:"Color \\ Weight"}),o.map(l=>e.jsx("th",{style:{padding:"8px 24px",fontSize:11,color:"var(--color-neutral-foreground-subtle-3)",fontWeight:700,letterSpacing:"0.07em",textTransform:"uppercase",textAlign:"center"},children:l},l))]})}),e.jsxs("tbody",{children:[r.map(l=>e.jsxs("tr",{style:{background:"var(--color-neutral-background-default)",borderTop:"1px solid var(--color-neutral-stroke-divider)"},children:[e.jsx("td",{style:{padding:"12px 16px 12px 0",fontSize:12,fontWeight:600,color:"var(--color-neutral-foreground-subtle-1)",verticalAlign:"middle"},children:l}),o.map(g=>e.jsx("td",{style:{padding:"12px 24px",verticalAlign:"middle",textAlign:"center"},children:e.jsx(t,{color:l,weight:g})},g))]},l)),e.jsxs("tr",{style:{background:"var(--color-neutral-background-default)",borderTop:"1px solid var(--color-neutral-stroke-divider)"},children:[e.jsx("td",{style:{padding:"12px 16px 12px 0",fontSize:12,fontWeight:600,color:"var(--color-neutral-foreground-subtle-1)",verticalAlign:"middle"},children:"live"}),e.jsx("td",{style:{padding:"12px 24px",verticalAlign:"middle",textAlign:"center"},children:e.jsx(t,{type:"live"})}),e.jsx("td",{})]}),e.jsxs("tr",{style:{background:"var(--color-neutral-background-default)",borderTop:"1px solid var(--color-neutral-stroke-divider)"},children:[e.jsx("td",{style:{padding:"12px 16px 12px 0",fontSize:12,fontWeight:600,color:"var(--color-neutral-foreground-subtle-1)",verticalAlign:"middle"},children:"liveLabel"}),e.jsx("td",{colSpan:2,style:{padding:"12px 24px",verticalAlign:"middle",textAlign:"center"},children:e.jsx(t,{type:"liveLabel"})})]})]})]})})}};var x,u,v;i.parameters={...i.parameters,docs:{...(x=i.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
    type: 'basic',
    color: 'alpha',
    weight: 'regular',
...
}`,...(v=(u=i.parameters)==null?void 0:u.docs)==null?void 0:v.source}}};var y,h,f;n.parameters={...n.parameters,docs:{...(y=n.parameters)==null?void 0:y.docs,source:{originalSource:`{
  tags: ['!autodocs'],
  name: 'Size',
  render: () => <div style={{
    display: 'flex',
...
}`,...(f=(h=n.parameters)==null?void 0:h.docs)==null?void 0:f.source}}};var m,b,j;d.parameters={...d.parameters,docs:{...(m=d.parameters)==null?void 0:m.docs,source:{originalSource:`{
  tags: ['!autodocs'],
  name: 'Contents',
  render: () => <div style={{
    display: 'flex',
...
}`,...(j=(b=d.parameters)==null?void 0:b.docs)==null?void 0:j.source}}};var k,B,w;s.parameters={...s.parameters,docs:{...(k=s.parameters)==null?void 0:k.docs,source:{originalSource:`{
  tags: ['!autodocs'],
  name: 'Matrix',
  render: () => {
...
}`,...(w=(B=s.parameters)==null?void 0:B.docs)==null?void 0:w.source}}};const A=["Playground","Sizes","Contents","Matrix"],O=Object.freeze(Object.defineProperty({__proto__:null,Contents:d,Matrix:s,Playground:i,Sizes:n,__namedExportsOrder:A,default:S},Symbol.toStringTag,{value:"Module"}));export{O,i as P};
