import{j as e}from"./jsx-runtime-DFAAy_2V.js";import{B as n}from"./Tooltip-Bwtpgy_W.js";import"./index-Bc2G9s8g.js";const p=({children:t,gap:o=20})=>e.jsx("div",{style:{display:"flex",alignItems:"flex-start",flexWrap:"wrap",gap:o},children:t}),c=({label:t,desc:o,children:r})=>e.jsxs("div",{style:{marginBottom:32},children:[e.jsx("p",{style:{fontFamily:"Pretendard, sans-serif",fontSize:11,fontWeight:700,letterSpacing:"0.07em",textTransform:"uppercase",color:"#9999B8",margin:"0 0 4px"},children:t}),o&&e.jsx("p",{style:{fontFamily:"Pretendard, sans-serif",fontSize:12,color:"#55557A",margin:"0 0 12px",lineHeight:1.6},children:o}),r]}),l=({children:t})=>e.jsx("p",{style:{fontFamily:"Pretendard, sans-serif",fontSize:11,color:"#9999B8",margin:"6px 0 0",textAlign:"center"},children:t}),T={title:"Assets/Badges/Tooltip",component:n,tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:`
툴팁형 뱃지 컴포넌트입니다.
...
}`,...(y=(h=i.parameters)==null?void 0:h.docs)==null?void 0:y.source}}};var v,b,j;s.parameters={...s.parameters,docs:{...(v=s.parameters)==null?void 0:v.docs,source:{originalSource:`{
  name: 'Contents',
  render: () => <div style={{
    display: 'flex',
    flexDirection: 'column',
...
}`,...(k=(z=d.parameters)==null?void 0:z.docs)==null?void 0:k.source}}};const L=["Playground","Sizes","Contents","Matrix"];export{s as Contents,d as Matrix,a as Playground,i as Sizes,L as __namedExportsOrder,T as default};
