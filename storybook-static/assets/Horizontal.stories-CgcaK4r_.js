import{j as e}from"./jsx-runtime-DFAAy_2V.js";import{R as o}from"./Vertical-BYffoIoG.js";import"./index-Bc2G9s8g.js";import"./Icon-Bs3x4phG.js";const l=({children:r,gap:t=16})=>e.jsx("div",{style:{display:"flex",alignItems:"center",flexWrap:"wrap",gap:t},children:r}),p=({label:r,desc:t,children:n})=>e.jsxs("div",{style:{marginBottom:32},children:[e.jsx("p",{style:{fontFamily:"Pretendard, sans-serif",fontSize:11,fontWeight:700,letterSpacing:"0.07em",textTransform:"uppercase",color:"var(--color-neutral-foreground-subtle-3)",margin:"0 0 4px"},children:r}),t&&e.jsx("p",{style:{fontFamily:"Pretendard, sans-serif",fontSize:12,color:"var(--color-neutral-foreground-subtle-1)",margin:"0 0 12px",lineHeight:1.6},children:t}),n]}),A={title:"Components/Reaction/Horizontal",component:o,tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:`
수평 리액션 버튼 컴포넌트입니다.
아이콘과 숫자가 가로로 배치됩니다.
...
}`,...(m=(x=s.parameters)==null?void 0:x.docs)==null?void 0:m.source}}};var y,f,g;i.parameters={...i.parameters,docs:{...(y=i.parameters)==null?void 0:y.docs,source:{originalSource:`{
  name: 'Size',
  render: () => {
...
}`,...(g=(f=i.parameters)==null?void 0:f.docs)==null?void 0:g.source}}};var k,h,b;c.parameters={...c.parameters,docs:{...(k=c.parameters)==null?void 0:k.docs,source:{originalSource:`{
  name: 'State',
  render: () => <div style={{
    display: 'flex',
    flexDirection: 'column',
...
}`,...(b=(h=c.parameters)==null?void 0:h.docs)==null?void 0:b.source}}};var v,z,j;d.parameters={...d.parameters,docs:{...(v=d.parameters)==null?void 0:v.docs,source:{originalSource:`{
  name: 'Matrix',
  render: () => {
    const types: ReactionType[] = ['like', 'comment', 'share', 'bookmark'];
...
}`,...(j=(z=d.parameters)==null?void 0:z.docs)==null?void 0:j.source}}};const D=["Playground","Size","State","Matrix"];export{d as Matrix,s as Playground,i as Size,c as State,D as __namedExportsOrder,A as default};
