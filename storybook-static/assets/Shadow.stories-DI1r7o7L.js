...
\`\`\`
        `.trim()}}},argTypes:{shadow:{control:"select",options:["none","up","down","up&down"],description:"그라디언트 방향",table:{type:{summary:"ImageShadowDirection"},defaultValue:{summary:"none"}}},showShadow:{control:"boolean",description:"그라디언트 오버레이 표시 여부",table:{defaultValue:{summary:"false"}}},width:{control:"number",description:"컴포넌트 너비 (px)",table:{type:{summary:"number"},defaultValue:{summary:"150"}}},height:{control:"number",description:"컴포넌트 높이 (px)",table:{type:{summary:"number"},defaultValue:{summary:"150"}}},src:{control:"text",description:"이미지 URL",table:{type:{summary:"string"}}},disabled:{control:"boolean",description:"비활성 상태 (opacity 0.35)",table:{defaultValue:{summary:"false"}}}}},t={args:{src:p,showShadow:!0,shadow:"down",width:148,height:148}},r={name:"Shadow",render:()=>e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:24},children:e.jsx(u,{label:"Shadow Directions",desc:"방향성 그라디언트 오버레이 비교",children:e.jsx(w,{gap:12,children:[{shadow:"none",showShadow:!1,desc:"오버레이 없음"},{shadow:"up",showShadow:!0,desc:"top → transparent"},{shadow:"down",showShadow:!0,desc:"bottom → transparent"},{shadow:"up&down",showShadow:!0,desc:"상하단 동시"}].map(({shadow:o,showShadow:a,desc:s})=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center"},children:[e.jsx(m,{src:p,shadow:o,showShadow:a,width:148,height:148}),e.jsx(g,{children:o}),e.jsx("p",{style:{fontFamily:"Pretendard,sans-serif",fontSize:10,color:"var(--color-neutral-foreground-disabled)",margin:"2px 0 0",textAlign:"center"},children:s})]},o))})})})};var n,d,i;t.parameters={...t.parameters,docs:{...(n=t.parameters)==null?void 0:n.docs,source:{originalSource:`{
  args: {
    src: IMG_SRC,
    showShadow: true,
    shadow: 'down',
...
}`,...(h=(c=r.parameters)==null?void 0:c.docs)==null?void 0:h.source}}};const b=["Playground","Directions"];export{r as Directions,t as Playground,b as __namedExportsOrder,y as default};
