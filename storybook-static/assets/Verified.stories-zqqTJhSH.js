import{j as e}from"./jsx-runtime-DiklIkkE.js";import{B as o}from"./Verified-CBYU3A0P.js";const S=({children:r,gap:t=20})=>e.jsx("div",{style:{display:"flex",alignItems:"center",flexWrap:"wrap",gap:t},children:r}),s=({label:r,desc:t,children:l})=>e.jsxs("div",{style:{marginBottom:32},children:[e.jsx("p",{style:{fontFamily:"Pretendard, sans-serif",fontSize:11,fontWeight:700,letterSpacing:"0.07em",textTransform:"uppercase",color:"#9999B8",margin:"0 0 4px"},children:r}),t&&e.jsx("p",{style:{fontFamily:"Pretendard, sans-serif",fontSize:12,color:"#55557A",margin:"0 0 12px",lineHeight:1.6},children:t}),l]}),k=({children:r})=>e.jsx("p",{style:{fontFamily:"Pretendard, sans-serif",fontSize:11,color:"#9999B8",margin:"6px 0 0",textAlign:"center"},children:r}),B={title:"Assets/Badges/Verified",component:o,parameters:{layout:"centered",docs:{description:{component:`
...
\`\`\`
        `.trim()}}},argTypes:{type:{control:"select",options:["official","local","verifiedSm","verifiedLg"],description:"인증 뱃지 타입"}}},n={args:{type:"official"}},i={tags:["!autodocs"],name:"Size",render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:24},children:[e.jsx(s,{label:"Measurement",children:e.jsx("div",{style:{overflowX:"auto"},children:e.jsxs("table",{style:{borderCollapse:"collapse",fontFamily:"Pretendard, sans-serif",fontSize:12,whiteSpace:"nowrap"},children:[e.jsx("thead",{children:e.jsx("tr",{style:{background:"var(--color-neutral-background-raised-1)",borderBottom:"1px solid var(--color-neutral-stroke-divider)"},children:["Attribute","official","local","verifiedSm","verifiedLg"].map(r=>e.jsx("th",{style:{padding:"8px 16px",textAlign:"center",fontWeight:700,color:"var(--color-neutral-foreground-subtle-1)"},children:r},r))})}),e.jsx("tbody",{children:[["Width","19px","19px","14px","22px"],["Height","15px","15px","14px","22px"],["Color","#3283FD","#03A94D","#3283FD","#3283FD"]].map(r=>e.jsx("tr",{style:{background:"var(--color-neutral-background-default)",borderBottom:"1px solid var(--color-neutral-stroke-divider)"},children:r.map((t,l)=>e.jsx("td",{style:{padding:"8px 16px",textAlign:"center",color:l===0?"var(--color-neutral-foreground-subtle-1)":"var(--color-neutral-foreground-default)",fontWeight:l===0?600:400},children:t},l))},r[0]))})]})})}),e.jsx(s,{label:"Usage",children:e.jsx(S,{children:["official","local","verifiedSm","verifiedLg"].map(r=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:4},children:[e.jsx(o,{type:r}),e.jsx(k,{children:r})]},r))})})]})},a={tags:["!autodocs"],name:"Contents",render:()=>e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:24},children:e.jsx(s,{label:"With text",desc:"프로필/채널명 옆에 인증 뱃지를 배치하는 예시.",children:e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:12,fontFamily:"Pretendard, sans-serif"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:4},children:[e.jsx("span",{style:{fontSize:14,fontWeight:600,color:"var(--color-neutral-foreground-default)"},children:"공식 채널"}),e.jsx(o,{type:"official"})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:4},children:[e.jsx("span",{style:{fontSize:14,fontWeight:600,color:"var(--color-neutral-foreground-default)"},children:"지역 채널"}),e.jsx(o,{type:"local"})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:4},children:[e.jsx("span",{style:{fontSize:14,fontWeight:600,color:"var(--color-neutral-foreground-default)"},children:"인증 사용자"}),e.jsx(o,{type:"verifiedSm"})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:4},children:[e.jsx("span",{style:{fontSize:16,fontWeight:700,color:"var(--color-neutral-foreground-default)"},children:"인증 사용자"}),e.jsx(o,{type:"verifiedLg"})]})]})})})},d={tags:["!autodocs"],name:"Matrix",render:()=>{const r=["official","local","verifiedSm","verifiedLg"];return e.jsx("div",{style:{fontFamily:"Pretendard, sans-serif",overflowX:"auto",padding:4},children:e.jsxs("table",{style:{borderCollapse:"collapse"},children:[e.jsx("thead",{children:e.jsxs("tr",{style:{background:"var(--color-neutral-background-raised-1)"},children:[e.jsx("th",{style:{padding:"8px 16px",textAlign:"left",fontSize:11,color:"var(--color-neutral-foreground-subtle-3)",fontWeight:700,letterSpacing:"0.07em",textTransform:"uppercase"},children:"Type"}),e.jsx("th",{style:{padding:"8px 24px",fontSize:11,color:"var(--color-neutral-foreground-subtle-3)",fontWeight:700,letterSpacing:"0.07em",textTransform:"uppercase",textAlign:"center"},children:"Preview"})]})}),e.jsx("tbody",{children:r.map(t=>e.jsxs("tr",{style:{background:"var(--color-neutral-background-default)",borderTop:"1px solid var(--color-neutral-stroke-divider)"},children:[e.jsx("td",{style:{padding:"12px 16px",fontSize:12,fontWeight:600,color:"var(--color-neutral-foreground-subtle-1)",verticalAlign:"middle"},children:t}),e.jsx("td",{style:{padding:"12px 24px",verticalAlign:"middle",textAlign:"center"},children:e.jsx(o,{type:t})})]},t))})]})})}};var c,p,f;n.parameters={...n.parameters,docs:{...(c=n.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
    type: 'official'
  }
...
}`,...(j=(b=d.parameters)==null?void 0:b.docs)==null?void 0:j.source}}};const z=["Playground","Sizes","Contents","Matrix"],D=Object.freeze(Object.defineProperty({__proto__:null,Contents:a,Matrix:d,Playground:n,Sizes:i,__namedExportsOrder:z,default:B},Symbol.toStringTag,{value:"Module"}));export{n as P,D as V};
